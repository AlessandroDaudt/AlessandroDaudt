...
Static, responsive portfolio landing page and GitHub profile README built from the public profile at [github.com/AlessandroDaudt](https://github.com/AlessandroDaudt).
...
`PROFILE_README.md` is the profile README version intended for the `AlessandroDaudt/AlessandroDaudt` repository.
